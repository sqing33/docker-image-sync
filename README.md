...
| 53  | bash:devel-alpine3.21          | `ghcr.nju.edu.cn/sqing33/bash:devel-alpine3.21`  | [yaml](https://github.com/sqing33/docker-image-sync/blob/main/docker-compose/bash.yaml)              | ✔️ |
