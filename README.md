...
| 111 | red1is | redis 数据库 | `docker pull ghcr.nju.edu.cn/sqing33/r1edis` | [redis.yaml](https://github.com/sqing33/docker-image-sync/blob/main/docker-compose/redis.yaml) |
### 使用方法
