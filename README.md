...
| 12 | redis2 | redis 数据库 | `docker pull ghcr.nju.edu.cn/sqing33/redis2` | [redis.yaml](https://github.com/sqing33/docker-image-sync/blob/main/docker-compose/redis.yaml) |
### 使用方法
